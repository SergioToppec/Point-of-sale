      ...
      {!redirecting && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden max-w-4xl w-full mx-4">
            ...
            <div className="px-3">
              <table className="w-full border-collapse text-sm border border-black border-opacity-30">
                <thead>
                  <tr className="text-white text-xs rounded-t-md" style={{ backgroundColor: "#395886" }}>
                    <th className="px-3 py-2 text-center font-medium">Clave producto</th>
