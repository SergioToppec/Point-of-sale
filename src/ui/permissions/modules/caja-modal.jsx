    ...
    <>
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 font-sans">
        <div className="bg-white rounded-lg shadow-xl w-[600px] max-w-4xl mx-4">
          {/* Header */}
          <div className="bg-azulOscuro text-white p-4 rounded-t-lg">
          ...
          <div className="p-6">
            <div className="flex gap-3 justify-start mb-6">
              ...
              <button
                ...
                className="bg-azulOscuro hover:bg-azulFuerte text-white p-3 rounded-lg flex flex-col items-center gap-2 transition-colors min-w-[96px]"
              >
