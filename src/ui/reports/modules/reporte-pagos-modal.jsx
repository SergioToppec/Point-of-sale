    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl w-[400px] mx-4 p-8">
        <div className="flex flex-col items-center text-center">
          ...
          <button
            onClick={onClose}
            className="bg-azulOscuro hover:bg-azulOscuro/90 text-white px-6 py-2 rounded-lg font-medium transition-colors"
          >
            Cerrar
          </button>
        </div>
          ...
          <div className="p-6">
            <div className="flex justify-between items-center mb-4 relative overflow-visible z-50">
              <button
                ...
                className="bg-azulOscuro hover:bg-azulOscuro/90 text-white px-4 py-2 rounded-lg font-medium transition-colors text-sm"
              >
                Total del día
              </button>
              ...
              <div className="relative z-50">
                <button
                  ...
                  className="flex items-center gap-2 text-sm bg-azulOscuro hover:bg-azulOscuro/90 text-white px-4 py-2 rounded-lg transition-colors"
                >
                  <FaFilter />
                  Filtrar
                </button>
                {isFilterDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-azulClaro rounded-lg shadow-lg z-[1000] overflow-visible">
                    <ul className="py-1">
            ...
            <div className="mb-6 overflow-hidden border border-gray-300 max-h-[250px] overflow-y-auto hide-scrollbar rounded-t-[10px]">
              <table className="w-full text-sm">
                <thead className="bg-azulOscuro text-white sticky top-0 z-10 rounded-t-[10px]">
                  <tr>
            ...
            <div className="flex justify-between items-end">
              ...
              <button
                onClick={onClose}
                className="bg-rojoFuerte hover:bg-rojoFuerte/90 text-white px-4 py-2 rounded-lg font-medium transition-colors text-sm"
              >
                Cancelar
              </button>
            </div>
